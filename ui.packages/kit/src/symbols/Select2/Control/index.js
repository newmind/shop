...
function Control({
  ...
  const { inProcess, isOpen, isDisabled, selectedObject, options, selectedValue, OptionTemplate, onTransformSelectedValue } = useContext(Context);
            ...
            { !! selectedValue && !! options.length
              ? (
                !! OptionTemplate
                  ...
                  : <span className={textColorClassName}>{ selectedText }</span>
              )

...
export const SOCKET_PRODUCT_CREATED = process.env['REACT_APP_SOCKET_PRODUCT_CREATED'];
export const SOCKET_PRODUCT_DELETED = process.env['REACT_APP_SOCKET_PRODUCT_DELETED'];
